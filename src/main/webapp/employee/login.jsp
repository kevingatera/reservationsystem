...
<body>
  ...
  <div class="container">
    <form method="POST" action="${contextPath}/employee/login" class="form-signin">
      ...
      <div class="form-group ${error != null ? 'has-error' : ''}">
        ...
        <h4 class="text-center"><a href="${contextPath}/employee/registration">Create an account</a></h4>
      </div>
    </form>
  </div>
