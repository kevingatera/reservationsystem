      ...
      <div class="card">
        <div class="card-body">
          <div class="form-group">
            ...
            <input type="text" class="form-control" placeholder="Enter Full Name" value="${viewProperty.propertyName}"
              readonly>
          </div>
          <div class="form-group">
            <label>Property Description <span class="text-danger">*</span></label>
            <textarea class="form-control" rows="4" value="${viewProperty.description}" readonly></textarea>
          </div>

          <div class="row">
            <div class="form-group col-md-4">
              <label>Type <span class="text-danger">*</span></label>
              <select id="typeSelect" class="form-control" readonly>
            ...
            <div class="form-group col-md-4">
              ...
              <input type="text" class="form-control" placeholder="Enter Rent/Booking Price" readonly>
            </div>
          </div>
          ...
          <div class="row">
            <div class="form-group col-md-4">
              ...
              <input type="text" class="form-control" placeholder="Enter Bedrooms" value="${viewProperty.bedrooms}"
                readonly>
            </div>
            <div class="form-group col-md-4">
              <label>Bathrooms <span class="text-danger">*</span></label>
              <input type="text" class="form-control" placeholder="Enter Bathrooms" value="${viewProperty.bathrooms}"
                readonly>
            </div>
            <div class="form-group col-md-4">
              <label>Max Occupancy <span class="text-danger">*</span></label>
              <input type="text" class="form-control" placeholder="Enter Max Occupancy"
                value="${viewProperty.maxGuests}" readonly>
            </div>
          </div>
          ...
          <div class="row">
            <div class="form-group col-md-4">
              ...
              <input type="number" class="form-control" placeholder="Enter Street Number"
                value="${viewPropertyAddress.streetNumber}" readonly>
            </div>
            <div class=" form-group col-md-4">
              <label>Street Name <span class="text-danger">*</span></label>
              <input type="text" class="form-control" placeholder="Enter Street Name"
                value="${viewPropertyAddress.streetName}" readonly>
            </div>
            <div class="form-group col-md-4">
              <label>Country<span class="text-danger">*</span></label>
              <input type="text" class="form-control" placeholder="Enter Country" value="${viewPropertyAddress.country}"
                readonly>
            </div>
            <div class="form-group col-md-4">
              <label>City <span class="text-danger">*</span></label>
              <input type="text" class="form-control" placeholder="Enter City" value="${viewPropertyAddress.city}"
                readonly>
            </div>
            <div class="form-group col-md-4">
